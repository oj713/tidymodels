...
* **`set_args()`** sets parameters specific to the initialized model. The names of these arguments are standardized so that similar parameters across models have the same name -- for example, `penalty` is the name of the regularization argument, if a model has one. 
