...
* The **`metrics()`** function will automatically choose metrics appropriate for the given data and present them as a tibble. It works for both regression and classification models. 
