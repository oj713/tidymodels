...
To create a training/testing split using RSample, we can use the `initial_split()` function. This function generates an `rsplit` object that contains partitioning information for the data.  
...
* https://rsample.tidymodels.org/articles/Working_with_rsets.html
  *  A helpful example of working with cross validation folds. Also touches on using RSample for the bootstrap method, which isn't touched on here. 