...
When building a model, the source dataset usually needs to be split up somehow. RSample contains tools for dataset resampling and splitting. 
...
* https://rsample.tidymodels.org/articles/Working_with_rsets.html
  *  A helpful example of working with cross validation folds and bootstrap, which I didn't cover here.