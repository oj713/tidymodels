...
[Tidymodels](https://www.tidymodels.org/) is a collection of packages developed for modeling and machine learning. These packages simplify the task of fitting a model to data by providing tools to assist with data pre-proprocessing, model initiation, and results valiation. Tidymodels emphasizes simple, readable code by creating common interfaces 

Tidymodels emphasizes simplicity and readability by abstracting complex modelling operations into common interfaces and optimizing functions for the [pipe operator](https://towardsdatascience.com/an-introduction-to-the-pipe-in-r-823090760d64).
