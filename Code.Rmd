...
This page contains the complete code for the iris modeling example. For a detailed walkthrough, look at the other pages on this site. Note that this example uses a `workflow` object to create the final predictions, and thus the recipe and parsnip model and not prepped or fit independently. 
